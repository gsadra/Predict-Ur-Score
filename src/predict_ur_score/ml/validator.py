...
class ModelValidation:
    ...
    SEARCH_SPACES: dict = {
        'random_forest': {
            ...
            'params': { 'model__n_estimators': [100, 200, 300, 500],
        ...
        'svm': {
            ...
            'params': { 'model__estimator__C': [0.1, 1, 10, 100],
    ...
    def tune_model( self, model_name: str, X: pd.DataFrame, y: pd.DataFrame) -> ModelSearch:
        ...
        return ModelSearch(model_name=model_name, 
                           best_params=search.best_params_, 
                           best_rmse=-search.best_score_, 
                           best_estimator=search.best_estimator_
        )

    def tune_all_models( self, X: pd.DataFrame, y: pd.DataFrame) -> list[ModelSearch]:
        results = [] 
